  ...
  describe '#attributes' do
    ...
    context 'when defining MEDIUMINT' do
      ...
      context 'with DEFAULT' do
        ...
        its([:default], activerecord_compatibility: RAILS_8_0) { is_expected.to eq('0') }
        its([:default], activerecord_compatibility: RAILS_8_1) { is_expected.to eq(0) }
      end
    ...
    context 'when defining FLOAT' do
      ...
      context 'with DEFAULT' do
        ...
        its([:default], activerecord_compatibility: RAILS_8_0) { is_expected.to eq('0') }
        its([:default], activerecord_compatibility: RAILS_8_1) { is_expected.to eq(0.0) }
      end
    ...
    context 'when defining BOOLEAN' do
      ...
      context 'with DEFAULT' do
        ...
        its([:default], activerecord_compatibility: RAILS_8_0) { is_expected.to eq('FALSE') }
        its([:default], activerecord_compatibility: RAILS_8_1) { is_expected.to eq(false) }
      end
